...
import { burnBatchErc1155Tx } from "../../../Lib/web3/transactions"
import Experience             from "../../../Experience/Experience"
import Contract               from "../../../Experience/World/Contract";

const BurnBatchERC1155: React.FC<{group: string, experience: Experience, props?: any}>  = ({ group, experience, props = {} }) => {
  ...
  experience.raycaster.on( `click_${group}_function_burnBatch`, () => { 
    setCurrMode(experience.controller.getCurrentMode())
  ...
  return (
    <mesh ref={burnBatchRef} name={`${group} burnBatch`} scale={0.6} position={ [ 0, -1, 0 ] }>
          ...
          >
            <ChakraProvider>
              <Box border={"2px solid #9ecaed"} overflowY="auto" width="268px" height={"268px"} padding="1rem" borderRadius={"32px"} textAlign="center" textColor={'white'} boxShadow={"inset 0 0 20px #9ecaed, 0 0 20px #9ecaed"}>
                <Box>
                  <Text fontWeight={"bold"} sx={{fontSize: "1rem"}} >mint batch</Text>
...
export default BurnBatchERC1155 