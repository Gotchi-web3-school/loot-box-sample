...
import { deployErc1155Tx }  from "../../../Lib/web3/transactions";

const ERC1155Deployer: React.FC<{group: string, experience: Experience}>  = ({ group, experience }) => {
              ...
              <Box border={"2px solid #9ecaed"}  overflowY="auto" width="268px" height={"268px"} padding="1rem" borderRadius={"32px"} textAlign="center" textColor={'white'} boxShadow={"inset 0 0 20px #9ecaed, 0 0 20px #9ecaed"}>
                ...
                <Stack py="0.5rem" alignItems={"left"} >
                  ...
                  <Box>
                    ...
                    <Input fontSize={"8px"} size="sm" padding="0.3rem" placeholder="gotchi lootbox" borderRadius={"5px"} {...register("uri")} />
                  </Box>
