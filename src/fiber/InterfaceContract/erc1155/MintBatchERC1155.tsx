...
import { mintBatchErc1155Tx } from "../../../Lib/web3/transactions"
import Experience             from "../../../Experience/Experience"
import Contract               from "../../../Experience/World/Contract";

const MintBatchERC1155: React.FC<{group: string, experience: Experience, props?: any}>  = ({ group, experience, props = {} }) => {
  ...
  experience.raycaster.on( `click_${group}_function_mintBatch`, () => { 
    setCurrMode(experience.controller.getCurrentMode())
  ...
  return (
    <mesh ref={mintBatchRef} name={`${group} mintBatch`} scale={0.6} position={ [ 0, -1, 0 ] }>
...
export default MintBatchERC1155 