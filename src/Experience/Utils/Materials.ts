...
export default class Materials {
  ...
  mapTextures()
  {
    ...
    this.items.contractInterfaceMaterial = new THREE.MeshStandardMaterial({ transparent: true, depthWrite: false, map: this.resources.items.contractInterfaceMaterial, side: THREE.DoubleSide })
